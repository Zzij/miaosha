...
public class UserServiceImpl implements UserService {
    ...
    public void register(UserModel userModel) throws BusinessException {
        ...
        try{
            ...
            throw new BusinessException(EmBusinessError.PARAMETER_VALIDATION_ERROR, "该手机已经注册过");
        }
    ...
    @Override
    public UserModel login(String phone, String encrptPassword) throws BusinessException {
        //通过用户的手机获取用户信息
